...
export default function CompetitionsPage() {
  ...
  return <AppShell active="profile" eyebrow="CONTEXTO" title="INTERENG" subtitle={canConfigure ? 'Configure o torneio e escolha o ano da edição ativa' : 'Torneio e edição em vigor no aplicativo'} actionHref={canConfigure ? '/competitions/new' : undefined} actionLabel="Novo torneio">
