...
import { listDisciplines, createId, editionStatus, editionStatuses, getEditionStatusLabel } from '@atletica-incinera/intereng-contract/rules';
...
export default function CompetitionsPage() {
  ...
  // A auditoria é lida por gente: guarda o rótulo, não o código do enum.
  function changeStatus(edition: EditionState, status: EditionState['status']) { void dispatch({ type: 'edition/update', payload: { id: edition.id, patch: { status } }, audit: { action: 'Status da edição alterado', entity: edition.name, before: getEditionStatusLabel(edition.status), after: getEditionStatusLabel(status) } }); }
