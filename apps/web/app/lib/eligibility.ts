...
import { isEliminationPhase } from './match-lifecycle.ts';
import { hasStarted, isTournamentStarted } from './status.ts';
import { athletesOfTeam, eligibleAthletes, findTeamByName, listTeams } from './edition-catalog.ts';
import type { Regulation } from './regulation.ts';

export type { AthleteView as AthleteRef } from './edition-catalog.ts';
...
export type { TeamView as TeamRef } from './edition-catalog.ts';
