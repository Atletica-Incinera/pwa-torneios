...
// A tela de promocao saiu da interface junto com os super admins; o prefixo
// fica bloqueado para todo mundo. Nome de `hiddenProductPrefixes` vem da
// mudanca que escondeu os super admins.
const hiddenProductPrefixes = ['/staff/promote'];
/*
...
export function AdminRouteGuard({ children }: { children: React.ReactNode }) {
  ...
  const forbidden = (session?.role === 'DISCIPLINE_MANAGER' && editionAdminPrefixes.some((prefix) => pathname.startsWith(prefix)))
    ...
    || (hiddenProductPrefixes.some((prefix) => pathname.startsWith(prefix)) && Boolean(session));
