...
export default defineConfig({
  ...
  webServer: process.env.E2E_EXTERNAL_SERVER ? undefined : { command: 'node .next/standalone/server.js', env: { PORT: '3101' }, url: 'http://127.0.0.1:3101', reuseExistingServer: false, timeout: 120_000 },
  projects: [
