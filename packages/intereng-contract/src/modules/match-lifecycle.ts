import type { MatchState } from './frontend-state.js';
import { absoluteMinutes } from './scheduling-rules.js';
import { regulationPeriodCount, setTarget, type Regulation } from './regulation.js';
