import type { DisciplineRule, DisciplineState } from './frontend-state.js';
import { defaultRegulationRule, describeCompletion, regulationFromRule } from './regulation.js';
